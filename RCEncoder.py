...
class CLIPTextEncoder(nn.Module):
    def __init__(self, text_encoder, args, delay_load=False):
        ...
        print("text_encoder_name", text_encoder)
...
class CLIPVisionTower(nn.Module):
    ...
    def forward(self, images, text_features):
        if type(images) is list:
            ...
            text_score = self.get_score_by_text(images, text_features)
            image_features = self.token_recycling_with_text_in_vision_and_clustring(images, text_score, reduction_ratio = 0.05)
